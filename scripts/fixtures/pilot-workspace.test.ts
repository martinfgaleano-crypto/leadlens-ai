...
[
 ...
 ["16 submit review",api.includes("review_required")],["17 accepted context explicit",core.includes("active_context_version:AMOR_ACCEPTED_CONTEXT.id")],["18 history preserved",!api.includes('.from("intelligence_client_intakes").update(')],
 ...
 ["40 entities",w.accounts.every((x:any)=>x.identity)],["41 zero signals",w.overview.signals===0],["42 evidence honest",w.overview.evidence_coverage.includes("explicit provenance")],
