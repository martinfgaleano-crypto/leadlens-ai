...
const env: EnvHealth = { supabase_url_set: true, supabase_anon_key_set: true, supabase_service_role_set: true, admin_secret_set: false, admin_session_secret_set: true, internal_run_secret_set: false, cron_secret_set: false, app_url_set: true, vercel_url_set: true, vercel_production_url_set: false, demo_mode: false, node_env: "production", supabase_ready: true, report_auth_ready: true, processor_ready: false, drainer_ready: false, cron_ready: false, production_safe: false, missing_for_production: ["INTERNAL_RUN_SECRET", "CRON_SECRET"] };
