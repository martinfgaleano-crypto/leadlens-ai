...
test("embedded name substring cannot resolve a different corporate identity", inferEnumeratedDomain("Ryder", [{ title: "Ryder logistics company", snippet: "United States logistics", url: "https://stryderusa.com/" }]).domain === null);
test("distinctive longer identity still resolves its own prefixed host", inferEnumeratedDomain("Stryder USA", [{ title: "Stryder USA logistics", snippet: "official company", url: "https://stryderusa.com/" }]).domain === "stryderusa.com");
...
test("a named US state is valid company-geography evidence", inferEnumeratedCountry("Nestlé", [{ title: "Nestlé launches a manufacturing facility in Arizona", snippet: "Nestlé opened the plant in Glendale, Arizona", url: "https://nestle.com/news/arizona-plant" }], "United States").country === "United States");
