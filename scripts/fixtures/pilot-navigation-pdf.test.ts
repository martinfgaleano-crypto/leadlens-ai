...
[
  ...
  ["22 PDF button visible", experience.includes("Descargar piloto en PDF")],
  ...
  ["28 internal notice", pdfSource.includes("INTERNO - NO APTO")],
  ["29 PDF contains ICP", pdfSource.includes("Perfil de cliente ideal")],
  ["30 PDF contains accounts", pdfSource.includes("Cuentas recomendadas")],
  ["31 PDF contains six profiles", pdfSource.includes("Perfiles de las seis cuentas")],
  ["32 evidence references", pdfSource.includes("official_properties")],
  ["33 limitations", pdfSource.includes("Metodología y limitaciones")],
  ...
  ["36 stable filename", endpoint.includes("leadlens-amor-de-gea-pilot-internal-${date}.pdf")],
