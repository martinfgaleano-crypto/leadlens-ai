...
const vertical = process.argv[2] === "warehouse" ? "warehouse" : "industrial";
const industrial = vertical === "industrial";
const industries = industrial ? ["food and beverage manufacturers"] : ["industrial distributors"];
const icp: ICP = { target_industries: industries, target_titles: [], company_size_range: "mid-market and enterprise", pain_points: [], disqualifiers: ["retailers", "consultants", "publishers", "government"], ideal_signals: industrial ? ["new plant", "capacity expansion"] : ["new warehouse", "automation investment"], exclusions_explicit: [] };
const criteria = { target_industries: industries, target_company_size: ["mid-market", "enterprise"], target_job_titles: [], target_geography: ["United States"], excluded_industries: [], buying_signals: icp.ideal_signals, disqualification_criteria: icp.disqualifiers, offer_summary: industrial ? "industrial automation and plant operations software" : "warehouse automation and WMS integration", value_proposition: industrial ? "coordinate owned production plants" : "coordinate owned distribution facilities", output_language: "en", target_market_region: "north_america", require_real_discovery: true } as unknown as LeadSearchCriteria;
const needs = { product_or_service: criteria.offer_summary, target_company_profile: industrial ? "mid-market and enterprise food and beverage manufacturers operating their own plants" : "mid-market and enterprise industrial distributors operating their own warehouses", buyer_problem: industrial ? "production complexity" : "inventory complexity", operational_trigger: industrial ? "new plant or production capacity" : "new warehouse or capacity", observable_signal: industrial ? "opened plant" : "opened distribution center", expected_need: industrial ? "plant operations coordination" : "warehouse orchestration", relevant_signal_families: industrial ? ["new_facility", "capacity", "operational_transformation"] : ["new_facility", "capacity", "technology_change"], disqualifiers: criteria.disqualification_criteria, supporting_evidence_required: [], counterevidence: [], possible_commercial_action: "validate direct operation" } as NeedsMap;
