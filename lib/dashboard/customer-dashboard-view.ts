...
export function buildCustomerDashboardView(input: {
  ...
  if (!input.onboarding_completed) return { stage: "setup_required", primary_action: { label: "Complete your business context", href: "/dashboard/icp" }, latest_brief: null, monitoring_count: monitoring, message: "Tell LeadLens what you sell, who should buy it, and where you want to grow." };
