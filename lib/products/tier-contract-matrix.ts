...
export const TIER_CONTRACT_MATRIX: CapabilityRow[] = [
  ...
  row("deep_dossiers", "Deep dossiers (count)", "report", "contracted_not_rendered", (e) => e.deep_dossiers),
  row("coverage_gaps", "Coverage gaps", "report", "contracted_not_rendered", (e) => e.coverage_gaps),
  row("portfolio_risk", "Portfolio risk", "report", "contracted_not_rendered", (e) => e.portfolio_risk),
  row("momentum", "Momentum", "report", "contracted_not_rendered", (e) => e.momentum),
  row("decay", "Decay", "report", "contracted_not_rendered", (e) => e.decay),
  row("market_patterns", "Market patterns", "report", "contracted_not_rendered", (e) => e.market_patterns),
  row("playbooks", "Playbooks", "report", "contracted_not_rendered", (e) => e.playbooks),
  row("stakeholder_hypotheses", "Stakeholder hypotheses", "report", "contracted_not_rendered", (e) => e.stakeholder_hypotheses),
  row("discovery_questions", "Discovery questions", "report", "contracted_not_rendered", (e) => e.discovery_questions),
