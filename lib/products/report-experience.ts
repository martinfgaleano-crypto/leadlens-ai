...
export function resolveReportExperience(planOrCode: string | null | undefined, language: "en" | "es" = "en"): ReportExperience {
  ...
  const upgrade: Record<string, string | null> = es ? {
    preview: "Validaste la calidad. Brief te da un conjunto enfocado y comparado de 6 empresas.",
    ...
    preview: "You validated the quality. Brief gives you a focused, compared set of 6 companies.",
