...
const HIGH = /\b(nueva planta|nueva f[aá]brica|nueva bodega|nueva tienda|abre (una )?nueva|abrir[aá] \d+ nuevas?|apertura de (una|un) nuev[ao]|nuevo centro de distribuci[oó]n|centro log[ií]stico|inaugur[oó]|expansi[oó]n regional|adquiri[oó]|adquisici[oó]n|compr[oó] (a|la|el)|nuevo contrato|adjudic[oó]|gan[oó] (el|un|la) (contrato|licitaci[oó]n)|amplí[oa] (su )?(capacidad|surtido)|nueva categor[ií]a|programa de bienestar|nueva operaci[oó]n|entra (a|al) (mercado|pa[ií]s)|ingres[oó] (a|al)|incorpor[oó] (\d+ )?veh[ií]culos|ampl[ií][oó] (su )?flota|crecimiento de (su )?flota|nueva flota|invierte|inversi[oó]n de|nueva ruta|nuevas rutas|new plant|new facility|new warehouse|new distribution center|acquired|acquisition|awarded (a )?contract|expanded (its )?(capacity|fleet|operations)|invests|new operation|enters (the )?(market|country))\b/i;
