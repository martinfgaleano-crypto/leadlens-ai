...
function buildDossier(opp: Json, lead: Json | undefined, es = false, clientObjective: string | null = null, canonicalCase: Json | null = null): AccountDossier {
  ...
  return {
    ...
    monitor_identity: c.account_identity ? {
      canonicalName: c.account_identity.canonicalName,
      domain: c.account_identity.domain ?? null,
      country: c.account_identity.country ?? null,
      organizationType: c.account_identity.organizationType ?? null,
      aliases: c.account_identity.aliases ?? [],
      confidence: c.account_identity.confidence,
      fromUniverse: c.account_identity.fromUniverse === true,
    } : null,
