...
const COPY = {
  en: {
    ...
    heroNote: "10 qualified leads + full outreach sequences. No subscription. No contract.",
  ...
  es: {
    ...
    heroNote: "10 leads calificados + secuencias de outreach completas. Sin suscripción. Sin contrato.",
  ...
  pt: {
    ...
    heroNote: "10 leads qualificados + sequências de outreach completas. Sem assinatura. Sem contrato.",
  ...
  ja: {
    ...
    heroNote: "10件の厳選リード + 完全なアウトリーチシーケンス。サブスクリプションなし。契約なし。",
