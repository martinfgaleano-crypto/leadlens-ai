...
export default function SignalReviewPage() {
  const [data, setData] = useState<{ groups: Group[]; progress: { reviewed: number; total: number }; distributions?: { rights: Record<string, number>; proposed_tier: Record<string, number> }; migration_missing?: boolean; banner: string } | null>(null);
