...
# Discovery Engine V2.3 checkpoint — 2026-08-07

Manufacturing benchmark cell #2 is complete as `discovery-v2-colombia-manufacturing-live-001`: 30 specialized-source candidates (ANDI n=5, ProColombia n=25), 22 accepted manufacturers, five subindustry groups, 25 search results and 7/10 safe digital resolutions. Observed manufacturer precision is 73.3%, exporter bias 96.7%, direct source-domain yield 0/30 and routing divergence high. Manufacturing now uses base sources plus subindustry/regional overlays; ANDI and ProColombia are benchmarked only in this context, never historically effective. Provider audit used 19/75 calls; Serper was exhausted, Tavily/Brave/Firecrawl worked. No migration, Pilot change, people data or Retail execution. Next decision: approve the layered model and start bounded Retail cell #3.
